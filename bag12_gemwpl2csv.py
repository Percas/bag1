...
# ############### Define functions #################################
def bag_gemwpl2csv(current_month='testdata',
    ...
    # short = {'gemwpl': 'GemeenteWoonplaatsRelatie'}
    ...
    df = df.sort_values(['wplid', 'gemwplvkbg'])
    # print(df.head(20))
    df = baglib.makecounter(df, 'wplid', 'gemwplvkid')
    # print(df[df['gemwplvkid']==2].head(20))
    # print(df.head(50))
...
if __name__ == '__main__':
    ...
    bag_gemwpl2csv(current_month=current_month,
                koppelvlak1=DIR01,
                koppelvlak2=DIR02,
                loglevel=printit)
